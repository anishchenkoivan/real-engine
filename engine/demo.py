...
class ExampleSceneLoader(SceneLoader):
    ...
    def define_materials_list(self):
        ...
        self.mt4 = Material(
            Color(0.8, 0.8, 0.9), 0.0, self, transparent=True, optical_density=1.4
        )
    ...
    def spawn_spheres(self):
        return [
            Sphere(Vector(-1.0, 1.0, 13.0), 1.5, self.mt1),
    ...
    def spawn_lenses(self):
        return [
            Lens(
                Sphere(Vector(1.0, 1.0, 19.5), 1.118, self.mt4),
                Plane(0.0, 0.0, 1.0, -20.0, self.mt4),
                self.mt4,
                Vector(0.0, 0.0, 1.0),
            ),
            Lens(
                Sphere(Vector(1.0, 1.0, 19.0), 1.0, self.mt4),
                Plane(0.0, 0.0, 1.0, -19.0, self.mt4),
                self.mt4,
                Vector(0.0, 0.0, 1.0),
            ),
        ]
